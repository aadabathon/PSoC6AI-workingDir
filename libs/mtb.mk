...
SEARCH_sensor-xensiv-bgt60trxx=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/sensor-xensiv-bgt60trxx/latest-v1.X
SEARCH_serial-flash=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/serial-flash/release-v1.4.3
SEARCH_wifi-core-freertos-lwip-mbedtls=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/wifi-core-freertos-lwip-mbedtls/latest-v1.X
SEARCH_xensiv-radar-presence=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/xensiv-radar-presence/latest-v1.X
...
SEARCH_CMSIS-DSP=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/CMSIS-DSP/v1.10.1
...
SEARCH_mtb-pdl-cat1=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/mtb-pdl-cat1/release-v3.22.0
...
SEARCH_sensor-dsp=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/sensor-dsp/release-v1.0.0
