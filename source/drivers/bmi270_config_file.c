/* ============================================================================
 * bmi270_config_file.c -- 8 KB firmware blob for the BMI270 feature engine
 *
 * Provenance: copied verbatim from Bosch's official reference driver
 *   github.com/boschsensortec/BMI270_SensorAPI -- bmi270.c, top of file.
 * License: BSD-3-Clause (see LICENSE in that repo). Keep that license
 *   reference if you push this anywhere public.
 *
 * Do NOT edit the bytes. They are firmware for an on-chip coprocessor;
 * the chip will not work without exactly this content.
 * ============================================================================
 */
